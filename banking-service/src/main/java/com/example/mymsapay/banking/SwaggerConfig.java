package com.example.mymsapay.banking;
...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        ...
        Server dockerServer = new Server().description("도커 서버").url("http://localhost:8082");
        Info info = new Info()
                .title("MSA 찍먹용 미니 페이 프로젝트의 banking service API")
                .version("1.0.0")
